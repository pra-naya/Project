<x-layout>
    ...
    <div class="container mt-4">
      ...
      <div class="rating-container my-4 lh-lg">
        {{-- <h3>Rate the Recipe!</h3> --}}
        <form action="/rating" method="POST">
            @csrf
            <button class="star" value="1" name="value"><i class="fa-solid fa-star" ></i></button>
            <button class="star" value="2" name="value"><i class="fa-solid fa-star" ></i></button>
            <button class="star" value="3" name="value"><i class="fa-solid fa-star" ></i></button>
            <button class="star" value="4" name="value"><i class="fa-solid fa-star" ></i></button>
            <button class="star" value="5" name="value"><i class="fa-solid fa-star" ></i></button>
